...
func archetypeDeleteController(c echo.Context) (err error) {
	span, _ := tracer.StartSpanFromContext(c.Request().Context(), "archetypeDeleteController", tracer.AnalyticsRate(1))
	...
	return c.JSON(statusCode, "INSERT_YOUR_CUSTOM_RESPONSE")
}
