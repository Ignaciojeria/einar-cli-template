...
func archetypePutController(c echo.Context) (err error) {
	span, _ := tracer.StartSpanFromContext(c.Request().Context(), "archetypePutController", tracer.AnalyticsRate(1))
