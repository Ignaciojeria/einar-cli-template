...
func archetypePatchController(c echo.Context) (err error) {
	span, _ := tracer.StartSpanFromContext(c.Request().Context(), "archetypePatchController", tracer.AnalyticsRate(1))
