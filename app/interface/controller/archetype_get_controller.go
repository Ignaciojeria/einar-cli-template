...
func archetypeGetController(c echo.Context) (err error) {
	span, _ := tracer.StartSpanFromContext(c.Request().Context(), "archetypeGetController", tracer.AnalyticsRate(1))
